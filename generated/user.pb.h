...
/* @@protoc_insertion_point(class_definition:titon.entity.User) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "titon.entity.User"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:titon.entity.User)
 private:
  class _Internal;
...
inline ::uint64_t User::id() const {
  // @@protoc_insertion_point(field_get:titon.entity.User.id)
  return _internal_id();
}
inline void User::set_id(::uint64_t value) {
  _internal_set_id(value);
  _impl_._has_bits_[0] |= 0x00000002U;
  // @@protoc_insertion_point(field_set:titon.entity.User.id)
}
...
inline const ::std::string& User::username() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:titon.entity.User.username)
...
PROTOBUF_ALWAYS_INLINE void User::set_username(Arg_&& arg, Args_... args) {
  ...
  // @@protoc_insertion_point(field_set:titon.entity.User.username)
}
inline ::std::string* PROTOBUF_NONNULL User::mutable_username()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::std::string* _s = _internal_mutable_username();
  // @@protoc_insertion_point(field_mutable:titon.entity.User.username)
  return _s;
}
...
inline ::std::string* PROTOBUF_NULLABLE User::release_username() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:titon.entity.User.username)
...
inline void User::set_allocated_username(::std::string* PROTOBUF_NULLABLE value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:titon.entity.User.username)
}
